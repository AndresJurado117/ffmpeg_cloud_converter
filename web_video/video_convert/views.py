...
from .global_variables import VIDEO_QP_MIN, VIDEO_QP_MAX, VIDEO_BITRATE_MIN, VIDEO_BITRATE_MAX, AUDIO_BITRATE_MIN, AUDIO_BITRATE_MAX, AUDIO_VOLUME_MIN, AUDIO_VOLUME_MAX, ENCODER_MODE, STORAGE_CONVERTED_VIDEOS
